...
public abstract class AbstractBedrockEntity extends Monster {
    private static final EntityDataAccessor<Integer> SKIN_ID = SynchedEntityData.defineId(AbstractBedrockEntity.class,
            EntityDataSerializers.INT);
    private static final EntityDataAccessor<String> STATE = SynchedEntityData.defineId(AbstractBedrockEntity.class,
            EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Boolean> IS_DELAYED_ATTACKING = SynchedEntityData
            .defineId(AbstractBedrockEntity.class, EntityDataSerializers.BOOLEAN);
